...
lab = Label(sp, text="Internet Speed Test", font=("Time New Roman", 30, "bold"), bg="skyblue", fg="purple")
lab.place(x=60, y=40, height=60, width=380)
...
button = Button(sp, text="Check Speed", font=("Time New Roman", 28, "bold"), relief=RAISED, bg="red", command=speedcheck)
